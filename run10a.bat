...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid.ps1' -Funds AAPL,MSFT,GOOGL,AMZN,NVDA -Population 10 -Generations 10 -GaSearchPreset grid -PriceColumn 'Adj Close' -LogFile 'run10a.log'"
