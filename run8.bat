...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid.ps1' -Funds JNJ  -Population 8 -Generations 4 -GaSearchPreset grid -PriceColumn 'Adj Close' -LogFile 'jnj-run8.log' %*"
