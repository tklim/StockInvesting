...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid2.ps1' -Funds AAPL -Population 16 -Generations 8 -GaSearchPreset grid -StrategyProfile generic -PriceColumn 'Adj Close' -LogFile 'run16.log'"
