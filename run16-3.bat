...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid.ps1' -Funds NVDA -DataSuffix '-3Y' -Population 16 -Generations 8 -GaSearchPreset grid -StrategyProfile generic -PriceColumn 'Adj Close' -LogFile 'nvda-run16-3Y.log'"
