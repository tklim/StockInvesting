...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid.ps1' -Funds V  -DataSuffix '-5Y' -Population 6 -Generations 3 -GaSearchPreset grid -PriceColumn 'Adj Close' -LogFile 'v-run6.log' %*"
