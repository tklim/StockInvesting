...
REM Second half of backtest\tickers.txt (META, TSLA, JPM, V, JNJ).
...
REM failures instead of spinning. See run10b.log for progress.

powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid.ps1' -Funds META,TSLA,JPM,V,JNJ -Population 10 -Generations 10 -GaSearchPreset grid -PriceColumn 'Adj Close' -LogFile 'run10b.log'"
