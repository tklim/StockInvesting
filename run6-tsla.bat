...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid.ps1' -Funds TSLA  -DataSuffix '-5Y' -Population 6 -Generations 3 -GaSearchPreset grid -PriceColumn 'Adj Close' -LogFile 'tsla-run6.log' %*"
