...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid.ps1' -Funds AAPL  -DataSuffix '-3Y' -Population 12 -Generations 6 -GaSearchPreset grid -StrategyProfile generic -PriceColumn 'Adj Close' -LogFile 'run12-3Y.log'"
