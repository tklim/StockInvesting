...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid.ps1' -Funds NVDA  -DataSuffix '-3Y' -Population 10 -Generations 5 -GaSearchPreset grid -PriceColumn 'Adj Close' -LogFile 'nvda-run10-3Y.log'"
