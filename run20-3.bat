...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid.ps1' -Funds NVDA  -DataSuffix '-3Y' -Population 20 -Generations 10 -GaSearchPreset grid -StrategyProfile generic -PriceColumn 'Adj Close' -LogFile 'nvda-run20-3Y.log'"
