...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid2.ps1' -Funds JNJ -Population 10 -Generations 5 -GaSearchPreset grid -PriceColumn 'Adj Close' -LogFile 'jnj-run10x.log'"
