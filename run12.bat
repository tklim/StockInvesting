...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "& '%~dp0run_grid.ps1' -Funds V  -Population 12 -Generations 6 -GaSearchPreset grid -StrategyProfile generic -PriceColumn 'Adj Close' -LogFile 'v-run12.log'"
